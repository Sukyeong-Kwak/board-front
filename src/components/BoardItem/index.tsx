...
import defaultProfileImage from 'assets/image/profile2.jpeg'
...
export default function BoradListItem({boardListItem}: Props) {
      ...
      <div className='board-list-item-main-box'>
        <div className='board-list-item-top'>
          ...
          <div className='board-list-item-write-box'>
            ...
            <div className='board-list-item-wrtie-date'>{writeDatetime}</div>
          </div>
        </div>
